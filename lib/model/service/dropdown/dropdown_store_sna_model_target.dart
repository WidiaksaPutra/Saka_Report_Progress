...
//
//     final dropdownStoreSnaTargetModelTarget = dropdownStoreSnaTargetModelFromJson(jsonString);

import 'dart:convert';

DropdownStoreSnaTargetModel dropdownStoreSnaTargetModelFromJson(String str) => DropdownStoreSnaTargetModel.fromJson(json.decode(str));

String dropdownStoreSnaTargetModelToJson(DropdownStoreSnaTargetModel data) => json.encode(data.toJson());

class DropdownStoreSnaTargetModel {
    final Meta? meta;
    final String? totalItems;
    final List<Datum>? data;

    DropdownStoreSnaTargetModel({
        this.meta,
        this.totalItems,
        this.data,
    });

    factory DropdownStoreSnaTargetModel.fromJson(Map<String, dynamic> json) => DropdownStoreSnaTargetModel(
