...
//
//     final grafikKunjunganSaaModel = grafikKunjunganSaaModelFromJson(jsonString);

import 'dart:convert';

GrafikKunjunganSaaModel grafikKunjunganSaaModelFromJson(String str) => GrafikKunjunganSaaModel.fromJson(json.decode(str));

String grafikKunjunganSaaModelToJson(GrafikKunjunganSaaModel data) => json.encode(data.toJson());

class GrafikKunjunganSaaModel {
    final Meta? meta;
    final Data? data;

    GrafikKunjunganSaaModel({
        this.meta,
        this.data,
    });

    factory GrafikKunjunganSaaModel.fromJson(Map<String, dynamic> json) => GrafikKunjunganSaaModel(
